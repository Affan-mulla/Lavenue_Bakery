...
export const menuData: MenuCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        basePrice: "$2.30",
        description: "Baked fresh daily",
        image: "https://images.unsplash.com/photo-1599819055803-717bba43890f?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
      {
      ...
      },
      {
        ...
        variants: [
          ...
          { label: "Walnut & Cranberry", price: "$8.75" },
          { label: "Olive", price: "$8.75" },
          { label: "Sunflower & Pumpkin Seed", price: "$8.75" },
        ],
      },
      {
        id: "flatbread",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Hot Tea",
        basePrice: "$3.75",
        image: "https://images.unsplash.com/photo-1606265771707-c052d0e14656?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
    ],
  },
  {
